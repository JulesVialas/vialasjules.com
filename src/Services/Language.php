    ...
    private static function loadTranslations(): void
    {
        self::$translations = [
            'fr' => [
                ...
                'about.description' => 'Je suis Jules Vialas, étudiant en Master MIAGE à l\'Université de Toulouse. Passionné par le développement informatique et les nouvelles technologies, je me spécialise dans la création d\'applications web et mobiles. Mon parcours m\'a permis d\'acquérir une solide expérience en développement full-stack, notamment à travers mes stages chez C1Partner et Subterra. Que vous soyez un particulier ayant besoin d\'une présence web ou une entreprise cherchant à optimiser ses processus, j\'offre des services informatiques adaptés à votre budget et à vos ambitions.',
                'resume.title' => 'CV',
